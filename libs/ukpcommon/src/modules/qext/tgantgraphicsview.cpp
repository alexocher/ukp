...
// qscrollbarVertgvPlanTree=NULL;
    ...
    int min_w = gv->minimumWidth();
    int max_w = gv->maximumWidth();// minimumWidth ()
    int min_h = gv->minimumHeight();
    int max_h = gv->maximumHeight();// minimumWidth ()
...
//#ifdef DEBUG_INFO
            ...
            int min = this->minimumWidth();
            int max = this->maximumWidth();//
